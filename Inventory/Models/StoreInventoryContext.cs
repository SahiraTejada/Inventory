...
public partial class StoreInventoryContext : DbContext
{
    ...
    public StoreInventoryContext(DbContextOptions<StoreInventoryContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27B28C49FE");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B42C5081AC");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB853A0AD548");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__4659622981959092");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5B5A7C283");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CA015DC1C");

            entity.ToTable("staffs");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164AC86F56F").IsUnique();
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C8C0B3F17");
