...
namespace Inventory.Controllers
{
    public class StocksController : Controller
    {
        ...
        public StocksController(StoreInventoryContext context)
        {
            _context = context;
        }
        ...
        {
            var storeInventoryContext = _context.Stocks.Include(s => s.Product).Include(s => s.Store);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StoreInventoryContext.Stocks'  is null.");
            }
            var stock = await _context.Stocks.FindAsync(id);
            if (stock != null)
            {
