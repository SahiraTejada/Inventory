...
namespace Inventory.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public StaffsController(StoreInventoryContext context)
        {
            _context = context;
        }
        ...
        {
            var storeInventoryContext = _context.Staffs.Include(s => s.Manager).Include(s => s.Store);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StoreInventoryContext.Staffs'  is null.");
            }
            var staff = await _context.Staffs.FindAsync(id);
            if (staff != null)
            {
