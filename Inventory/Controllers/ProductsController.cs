...
namespace Inventory.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(StoreInventoryContext context)
        {
            _context = context;
        }
        ...
        {
            var storeInventoryContext = _context.Products.Include(p => p.Brand).Include(p => p.Category);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StoreInventoryContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
