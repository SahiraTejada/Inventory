...
namespace Inventory.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(StoreInventoryContext context)
        {
            _context = context;
        }
        ...
        {
            var storeInventoryContext = _context.Orders.Include(o => o.Customer).Include(o => o.Staff).Include(o => o.Store);
            return View(await storeInventoryContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StoreInventoryContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
