...
namespace Inventory.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public OrderItemsController(StoreInventoryContext context)
        {
            _context = context;
        }
        ...
        {
            var storeInventoryContext = _context.OrderItems.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StoreInventoryContext.OrderItems'  is null.");
            }
            var orderItem = await _context.OrderItems.FindAsync(id);
            if (orderItem != null)
            {
